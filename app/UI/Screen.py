...
logo1 = Image.open(os.path.join(base_path, "assets/logo1.png"))
logo2 = Image.open(os.path.join(base_path, "assets/logo2.png"))
logo3 = Image.open(os.path.join(base_path, "assets/logo3.png"))
logo4 = Image.open(os.path.join(base_path, "assets/logo4.png"))
    ...
    """) as demo:
        with gr.Row(elem_id="logo-row"):
            with gr.Row(elem_id="logo-wrapper"):
                gr.Image(value=logo1, show_label=False, show_download_button=False, elem_id="logo1", elem_classes=["logo-img"], container=False,show_fullscreen_button=False)
                gr.Image(value=logo2, show_label=False, show_download_button=False, elem_id="logo2", elem_classes=["logo-img"], container=False,show_fullscreen_button=False)
                gr.Image(value=logo3, show_label=False, show_download_button=False, elem_id="logo3", elem_classes=["logo-img"], container=False,show_fullscreen_button=False)
                gr.Image(value=logo4, show_label=False, show_download_button=False, elem_id="logo4", elem_classes=["logo-img"], container=False,show_fullscreen_button=False)
